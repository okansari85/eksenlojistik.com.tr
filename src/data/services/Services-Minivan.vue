<template>
  ...
  <div class="row justify-content-between">
    <div class="col-md-6">
      <div>
        <h5 class="display-6 fw-500">Minivan Taşımacılık</h5>
        <p class="py-3">Tüm Avrupa ülkelerine daha hızlı Sevkiyat imkanı . Avrupa’nın tüm bölgelerine 2-3 günde teslimat yapmaktayız. 
